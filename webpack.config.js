...
module.exports = {
  ...
  entry: ['./src/scss/styles.scss', './src/js/index.ts'],
  module: {
    ...
    },
    {
        ...
        test:/\.(s*)css$/,
        use:[{loader :'file-loader', options: {name: 'styles.css'}}, 'extract-loader', 'css-loader', 'sass-loader']
    },
    {
...

    {
      ...
      test: /.(ttf|otf|eot|otf|woff(2)?)(\?[a-z0-9]+)?$/,
      use: [{
        loader: 'file-loader',
        options: {
          name: '[name].[ext]',
...

      {
        ...
        use: [{
          ...
          options: {
            name: '[name].[ext]',
            outputPath: 'svg/',    // where the svg will go
